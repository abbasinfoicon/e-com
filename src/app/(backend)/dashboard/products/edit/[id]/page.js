...
const EditProduct = () => {
  return (
    <div className="page-body">
            <Breadcrumb title="Edit Product" subtitle="Multikart Admin panel" parent="products" />
                                        ...
                                        <form className="needs-validation add-product-form" novalidate="">
                                            <div className="form">
                                                <div className="form-group mb-3 row">
                                                    <label for="title"
                                                        className="col-xl-3 col-sm-4 mb-0">Title :</label>
                                                ...
                                                <div className="form-group mb-3 row">
                                                    <label for="price"
                                                        className="col-xl-3 col-sm-4 mb-0">Price :</label>
                                                    <div className="col-xl-8 col-sm-7">
                                                ...
                                                <div className="form-group mb-3 row">
                                                    <label for="prdcode"
                                                        className="col-xl-3 col-sm-4 mb-0">Product Code :</label>
                                                    <div className="col-xl-8 col-sm-7">
                                            ...
                                            <div className="form">
                                                <div className="form-group row">
                                                    <label for="size"
                                                        className="col-xl-3 col-sm-4 mb-0">Select Size :</label>
                                                    <div className="col-xl-8 col-sm-7">
