...
const ShippingReturn = () => {
  return (
    <>
      <Breadcrumb title="Shpping Return" />

      <section className="about-page section-b-space">
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              <h4>Shpping Return</h4>
              ...
              <p><strong>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus repudiandae perspiciatis, cumque similique tempora eveniet.</strong></p>
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat, sunt saepe? Repellat distinctio voluptatem ea, sed laudantium impedit unde?
                Sequi sed officia consectetur. Doloribus magni pariatur totam sequi sint quis.</p>
